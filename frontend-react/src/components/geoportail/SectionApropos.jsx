...
,
  ...
  { titleFr:'Visite du Ministre \u2014 Mars 2026', titleEn:'Minister Visit \u2014 March 2026', longText:true, syncPhoto:2, textFr:'Le 17 mars 2026, à l’occasion de sa visite à l’Institut Agronomique et Vétérinaire Hassan II, Monsieur Ahmed El Bouari, ministre de l’Agriculture, de la Pêche maritime, du Développement rural et des Eaux et Forêts, a effectué une tournée des principales infrastructures pédagogiques et scientifiques récemment modernisées. Parmi les étapes marquantes de cette visite figurait l’Agro-Biotech Greenhouse, la nouvelle serre expérimentale automatisée de l’Institut, qui incarne les ambitions de l’IAV Hassan II en matière d’innovation, de recherche appliquée et d’agriculture de précision.\n\nRéalisée avec une enveloppe budgétaire de 13 millions de dirhams, cette infrastructure de haute technologie constitue une plateforme expérimentale de référence dédiée à l’étude et au développement de systèmes de production agricole innovants. Composée de cinq compartiments indépendants offrant des conditions environnementales contrôlées, elle permet de conduire des essais scientifiques dans des contextes variés tout en assurant un suivi précis des paramètres climatiques et agronomiques. Grâce à ses équipements automatisés et à ses capacités d’expérimentation avancées, l’Agro-Biotech Greenhouse offre aux chercheurs, enseignants et étudiants un cadre privilégié pour concevoir et évaluer des solutions répondant aux enjeux de durabilité, de gestion efficiente des ressources et d’adaptation aux changements climatiques.', textEn:'On March 17, 2026, during his visit to the Institut Agronomique et Vétérinaire Hassan II, Mr. Ahmed El Bouari, Minister of Agriculture, Maritime Fisheries, Rural Development and Water and Forests, toured the main recently modernized educational and scientific infrastructure. Among the highlights of this visit was the Agro-Biotech Greenhouse, the Institute’s new automated experimental greenhouse, which embodies IAV Hassan II’s ambitions in terms of innovation, applied research and precision agriculture.\n\nBuilt with a budget of 13 million dirhams, this high-technology infrastructure constitutes a reference experimental platform dedicated to the study and development of innovative agricultural production systems. Comprising five independent compartments offering controlled environmental conditions, it allows scientific trials to be conducted in various contexts while ensuring precise monitoring of climatic and agronomic parameters. Thanks to its automated equipment and advanced experimentation capabilities, the Agro-Biotech Greenhouse offers researchers, teachers and students a privileged framework for designing and evaluating solutions to the challenges of sustainability, efficient resource management and climate change adaptation.' },
]
