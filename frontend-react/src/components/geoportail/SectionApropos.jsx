...
const PHOTOS = [
  { src: "/complexe-exterieur.jpg",  labelFr: "Vue extérieure du complexe",    labelEn: "Complex exterior view",       ratio: "1/1"  },
  { src: "/visite-officielle.jpg",   labelFr: "Visite officielle - intérieur", labelEn: "Official visit - interior",   ratio: "16/9" },
  { src: "/inspection-cultures.jpg", labelFr: "Inspection des cultures",       labelEn: "Research crop inspection",    ratio: "14/9" },
]
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', alignItems: 'stretch' }}>
          ...
          <div style={{ background: cardBg, border: '1px solid ' + cardBorder, borderRadius: '24px', padding: '2rem', position: 'relative', display: 'flex', flexDirection: 'column', backdropFilter: 'blur(16px)', boxShadow: darkMode ? '0 4px 24px rgba(0,0,0,0.4)' : '0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '0 2.5rem' }}>
              <div style={{ fontSize: '18px', fontWeight: 800, color: textColor, marginBottom: '1rem' }}>
                {lang === 'fr' ? item.titleFr : item.titleEn}
              </div>

              {isLong ? (
                <div style={{ position: 'relative' }}>
                  <div style={{ maxHeight: expanded ? '600px' : '9.5em', overflow: 'hidden', transition: 'max-height 0.4s ease', fontSize: '13.5px', color: textSecond, lineHeight: 1.85, whiteSpace: 'pre-line' }}>
                  ...
                  <button onClick={() => setExpanded(e => !e)} style={{ marginTop: '10px', background: 'none', border: '1px solid rgba(34,197,94,0.5)', borderRadius: '6px', color: '#22C55E', fontSize: '12px', fontWeight: 700, cursor: 'pointer', padding: '4px 14px' }}>
