      ...
      <div style={{ maxWidth: '1160px', margin: '0 auto' }}>
        ...
        {vrSupported !== null && (
          <div style={{
            ...
            {/* VR entry — always visible */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
              {vrSupported && <span style={{ width: '7px', height: '7px', borderRadius: '50%', background: '#8B5CF6', boxShadow: '0 0 8px rgba(139,92,246,0.8)', display: 'inline-block', animation: 'vPulse 2s infinite' }} />}
              <a
                ...
                style={{
                  ...
                  color: vrSupported ? '#fff' : inkSub,
                  background: vrSupported
                    ? 'linear-gradient(135deg,rgba(139,92,246,.35),rgba(99,102,241,.28))'
                    : (isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.04)'),
                  border: `1.5px solid ${vrSupported ? 'rgba(139,92,246,0.55)' : glassBorder}`,
                  borderRadius: '10px', padding: '7px 14px',
                  boxShadow: vrSupported ? '0 0 20px rgba(139,92,246,0.35)' : 'none',
                ...
                {lang === 'fr' ? 'Expérience VR' : 'VR Experience'}
              </a>
            </div>
          </div>
        )}
    ...
    <div style={{ borderRadius: '24px', overflow: 'hidden', border: `1px solid ${glassBorder}`, boxShadow: isDark ? `0 32px 80px rgba(0,0,0,0.55),0 0 0 1px ${viewer.color}12` : '0 16px 48px rgba(0,0,0,0.09)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px', background: isDark ? 'rgba(7,17,31,0.95)' : 'rgba(255,255,255,0.97)', backdropFilter: 'blur(16px)', borderBottom: `1px solid ${glassBorder}` }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {/* VR button — always opens cinematic vr-intro experience */}
          <a
            href="/walkthrough/vr-intro.html"
            target="_blank"
            rel="noopener noreferrer"
